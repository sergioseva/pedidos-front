...
export class PrintRemitoService {
   ...
   */
  /** Estado de cuenta de un comercio: todo lo que tiene en su poder, sin recortes por fecha. */
  imprimirEstadoCuenta(comercioId: number) {
    this.isPrinting = true;
    this.router.navigate(['/',
    { outlets: {
      'print': ['print', 'printestadocuenta', comercioId]
    }}]);
  }
